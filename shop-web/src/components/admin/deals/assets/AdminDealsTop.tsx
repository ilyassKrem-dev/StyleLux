...
export default function AdminDealsTop() {
    ...
    return (
        <div className=" p-4 bg-white dark:bg-dark border-black/5 border rounded-md dark:border-white/5 pb-5 flex items-center gap-6 w-full">
            <Link to={"/admin/products"} className="font-bold text-xl w-[150px] dark:text-white active:scale-95 cursor-pointer">Deals</Link>
