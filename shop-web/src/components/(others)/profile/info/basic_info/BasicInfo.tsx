...
export default function BasicInfo(props:Props) {
    ...
    return (
        <div className="flex flex-col  pt-3 border rounded-lg border-black/10 dark:text-white dark:border-white/20">
            <h1 className=" font-semibold text-xl px-4">Basic info</h1>
            <div className="mt-4 flex flex-col">
                <div className="relative px-4 group cursor-pointer active:bg-black/20">
