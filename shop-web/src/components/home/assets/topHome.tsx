...
export default function TopHome() {
    ...
    return (
        <div className="flex items-center gap-3 h-[600px]">
                {w>631&&<div className="flex-1 rounded-md bg-gray-300 dark:bg-white h-full">
                    <img 
                    src="/home/image1.png" 
                    alt="image"
                ...
                <div className="flex-1 flex flex-col gap-1 h-full">
                    <div className="h-[130px] bg-rose-400 rounded-md">
                        <img 
                        src="/home/image2.png" 
                        alt="image"
                    ...
                    <div className="flex-1 flex flex-col gap-3 justify-start items-center">
                        <div className="h-[200px]">
                            <div className="relative flex items-center justify-center">
                                ...
                                <h3 className="text-stroke text-transparent  text-[100px] absolute top-[5rem] dark:text-stroke-white"> SALE</h3>
                            </div>
                        </div>
                    ...
                    <div className="h-[130px] bg-orange-300 rounded-md">
                        <img 
                        src="/home/image4.png" 
                        alt="image"
                        className="w-full h-full object-cover rounded-md" />
                ...
                {w>530&&<div className="flex-1 rounded-md bg-gray-300 h-full dark:bg-white">
                    <img 
                    src="/home/image3.png" 
                    alt="image"
                    className="w-full h-full object-cover rounded-md" />
